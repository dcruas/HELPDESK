...
begin
   ...
   helpdesk.queryFUNCIONARIO.Open;
   matricula := helpdesk.queryFUNCIONARIO.FieldByName('ID').AsInteger;
   helpdesk.queryFUNCIONARIO.SQL.Clear;
...
txtNome.Text := DBGrid1.Fields[1].AsString;
txtAndar.Text := DBGrid1.Fields[2].AsString;
txtRamal.Text := DBGrid1.Fields[3].AsString;
txtCelular.Text := DBGrid1.Fields[4].AsString;
txtEmail.Text := DBGrid1.Fields[5].AsString;
txtSala.Text := DBGrid1.Fields[6].AsString;
txtDataAdmissao.Text := DBGrid1.Fields[7].AsString;
txtCPF.Text := DBGrid1.Fields[9].AsString;
