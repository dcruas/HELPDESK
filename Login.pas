...
begin
 ...
 if helpdesk.TB_FUNCIONARIO.Locate('NR_MATRICULA', txtMatricula.Text, [loCaseInsensitive ]) and
  ...
  begin
      if helpdesk.TB_FUNCIONARIO.Locate('NR_SITUACAO', 1, [loCaseInsensitive ]) then
      begin
          if helpdesk.TB_FUNCIONARIO.Locate('CD_ACESSO', 1, [loCaseInsensitive ]) then
          begin
